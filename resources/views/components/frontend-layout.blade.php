...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
		...
		<div class="modal fade" id="kt_modal_UNDER_CONSTRUCTION" tabindex="-1">
                ...
                <!--begin::Alert-->
                        <div class="alert alert-danger">
                            ...
                            <div class="d-flex flex-column">
                                <!--begin::Title-->
                                <h4 class="mb-1 text-danger">UNDER CONSTRUCTION</h4>
                                <!--end::Title-->
                                <!--begin::Content-->
                                <span class='pt-5'>Our<code>Website</code> is under construction. If you need any-help or estimate Please call us at: <code>{{ $wb_setting->whatsapp}}</code></span>
                                <!--end::Content-->
                            </div>
                            <!--end::Wrapper-->
                        </div>
