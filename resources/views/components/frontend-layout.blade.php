    ...
    <body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
		...
		@if($alerts)
			@foreach($alerts as $_A)
				...
				<div class="modal fade" id="kt_modal_{{ Str::slug($_A->title,  '_') }}" tabindex="-1">
        ...
        <!--                 <h5 class="modal-title">Modal title</h5> -->
                      ...
                      <div class="modal-body">
                        <!--begin::Alert-->
                                <div class="alert alert-{{ $alert }}">
                                    <!--begin::Icon-->
                                    <span class="svg-icon svg-icon-2hx svg-icon-{{ $alert }} me-4">
                                    ...
                                    <div class="d-flex flex-column">
                                        <!--begin::Title-->
                                        <h4 class="mb-1 text-{{ $alert }}">{{ $_A->title }}</h4>
                                        <!--end::Title-->
                                        <!--begin::Content-->
                                        <span class='pt-5'>{!! str_replace('%PHONE_NUMBER%', $wb_setting->whatsapp, $_A->msg) !!}</span>
                                        <!--end::Content-->
                                    </div>
                                    <!--end::Wrapper-->
                                </div>
        	    ...
        	    <script type="text/javascript">
        			$(function(){
        				var myModal = new bootstrap.Modal(document.getElementById("kt_modal_{{ Str::slug($_A->title,  '_') }}"))
        				myModal.show();
        			});
        		</script>
			@endforeach
