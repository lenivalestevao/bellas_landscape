                            ...
                            <table class="inner-body" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 48px;">
                                        @yield('content')
                                        <div style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; margin-bottom: 0; text-align: left;">
                            ...
                            <table class="footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px 0 20px;">
                                        <a href="{{ route('frontend.home') }}" class='brand-logo'>
                                            <img alt="Logo"
                                            	src="{{ route('images', ['width' => '110','height' => '60', 'type' => 'logo', 'image'=> $logo]) }}" />
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="content-cell" align="center" style="padding:0;">
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; margin-bottom: 24; color: #AEAEAE; font-size: 12px; text-align: center;">
