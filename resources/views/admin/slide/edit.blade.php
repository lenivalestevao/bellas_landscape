        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="flex-wrap mb-5 page-title d-flex align-items-center me-3 mb-lg-0 lh-1">
                    <!--begin::Title-->
                    <h1 class="my-1 d-flex align-items-center text-dark fw-bolder fs-3">Update Slide
                        <!--begin::Separator-->
                ...
                <div class='row'>
                    <div class="card">
                         ...
                         <div class="card-body pt-0">
                     	 	@livewire('admin.generic.fieldgeneric', ['fields' => $fields, 'action' => 'admin.slides.update', 'obj' => $slide ])
                         </div>
                    </div>
                </div>
            </div>
